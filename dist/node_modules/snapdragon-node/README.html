...
<pre><code class="language-js">var Node = require('snapdragon-node');
...
<pre><code class="language-js">var node = new Node('*', 'Star');
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var node = new Node();
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var node = new Node({type: 'text'});
node.isEmpty(); //=&gt; true
node.val = 'foo';
node.isEmpty(); //=&gt; false
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var foo = new Node({type: 'foo'});
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var node = new Node({type: 'foo'});
...
<p><strong>Example</strong></p>
<pre><code class="language-js">node.remove(childNode);
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var child = node.find(1); //&lt;= index of the node to get
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var node = new Node({type: 'bar'});
