...
<pre><code class="language-sh">$ npm install has-values --save
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var hasValue = require('has-values');
...
<pre><code class="language-js">function isEmpty(o, isZero) {
