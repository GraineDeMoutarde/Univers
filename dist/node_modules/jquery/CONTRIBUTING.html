...
<h3>Make sure it is a jQuery bug</h3>
...
<h3>Disable any browser extensions</h3>
...
<h3>Try the latest version of jQuery</h3>
...
<h3>Try an older version of jQuery</h3>
...
<h2>jQuery Core Style Guide</h2>
<p>See: <a href="http://docs.jquery.com/JQuery_Core_Style_Guidelines">jQuery Core Style Guide</a></p>
<h2>Tips For Bug Patching</h2>
<h3>Environment: localhost w/ PHP, Node &amp; Grunt</h3>
...
<h3>Build a Local Copy of jQuery</h3>
...
<pre><code class="language-bash">$ cd /path/to/your/www/root/
</code></pre>
<p>Clone your jQuery fork to work locally</p>
<pre><code class="language-bash">$ git clone git@github.com:username/jquery.git
</code></pre>
<p>Change directory to the newly created dir jquery/</p>
<pre><code class="language-bash">$ cd jquery
</code></pre>
<p>Add the jQuery master as a remote. I label mine &quot;upstream&quot;</p>
<pre><code class="language-bash">$ git remote add upstream git://github.com/jquery/jquery.git
</code></pre>
<p>Get in the habit of pulling in the &quot;upstream&quot; master to stay up to date as jQuery receives new commits</p>
<pre><code class="language-bash">$ git pull upstream master
</code></pre>
<p>Run the Grunt tools:</p>
<pre><code class="language-bash">$ grunt &amp;&amp; grunt watch
</code></pre>
...
<h3>Fix a bug from a ticket filed at bugs.jquery.com:</h3>
...
<pre><code class="language-bash">$ git checkout -b bug_####
...
<pre><code class="language-bash">$ git commit -m &quot;Brief description of fix. Fixes #0000&quot;
</code></pre>
...
<pre><code class="language-bash">$ git push origin -u bug_####
</code></pre>
<p>Before you tackle your next bug patch, return to the master:</p>
<pre><code class="language-bash">$ git checkout master
</code></pre>
<h3>Test Suite Tips...</h3>
...
<h3>jQuery supports the following browsers:</h3>
<ul>
