...
<pre><code class="language-sh">$ npm install --save expand-tilde
</code></pre>
<h2>Usage</h2>
...
<pre><code class="language-js">var expandTilde = require('expand-tilde');
