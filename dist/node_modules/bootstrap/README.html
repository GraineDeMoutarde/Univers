...
<li>Install with <a href="https://yarnpkg.com/">yarn</a>: <code>yarn add bootstrap@4.1.3</code></li>
<li>Install with <a href="https://getcomposer.org/">Composer</a>: <code>composer require twbs/bootstrap:4.1.3</code></li>
...
<p>Read the <a href="https://getbootstrap.com/docs/4.1/getting-started/introduction/">Getting started page</a> for information on the framework contents, templates and examples, and more.</p>
<h2>Status</h2>
...
<p>Documentation search is powered by <a href="https://community.algolia.com/docsearch/">Algolia's DocSearch</a>. Working on our search? Be sure to set <code>debug: true</code> in <code>site/docs/4.1/assets/js/src/search.js</code> file.</p>
<h3>Running documentation locally</h3>
<ol>
<li>Run through the <a href="https://getbootstrap.com/docs/4.1/getting-started/build-tools/#tooling-setup">tooling setup</a> to install Jekyll (the site builder) and other Ruby dependencies with <code>bundle install</code>.</li>
...
<h2>Versioning</h2>
<p>For transparency into our release cycle and in striving to maintain backward compatibility, Bootstrap is maintained under <a href="https://semver.org/">the Semantic Versioning guidelines</a>. Sometimes we screw up, but we'll adhere to those rules whenever possible.</p>
